...
.method public addConnectionStateListener(Lcom/google/android/gtalkservice/IConnectionStateListener;)V
    .locals 5
    .param p1, "listener"    # Lcom/google/android/gtalkservice/IConnectionStateListener;
...
.method public addGroupChatInvitationListener(Lcom/google/android/gtalkservice/IGroupChatInvitationListener;)V
    .locals 5
    .param p1, "listener"    # Lcom/google/android/gtalkservice/IGroupChatInvitationListener;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public addRemoteJingleInfoStanzaListener(Lcom/google/android/gtalkservice/IJingleInfoStanzaListener;)V
    .locals 5
    .param p1, "listener"    # Lcom/google/android/gtalkservice/IJingleInfoStanzaListener;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public addRemoteSessionStanzaListener(Lcom/google/android/gtalkservice/ISessionStanzaListener;)V
    .locals 5
    .param p1, "listener"    # Lcom/google/android/gtalkservice/ISessionStanzaListener;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public createChatSession(Ljava/lang/String;)Lcom/google/android/gtalkservice/IChatSession;
    ...
    .line 956
    iget-object v3, p0, Lcom/google/android/gtalkservice/IImSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-static {v3}, Lcom/google/android/gtalkservice/IChatSession$Stub;->asInterface(Landroid/os/IBinder;)Lcom/google/android/gtalkservice/IChatSession;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 961
    .local v2, "_result":Lcom/google/android/gtalkservice/IChatSession;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 961
    .end local v2    # "_result":Lcom/google/android/gtalkservice/IChatSession;
    :catchall_0
    move-exception v3
...
.method public getAccountId()J
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string v4, "com.google.android.gtalkservice.IImSession"

    invoke-virtual {v0, v4}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 517
    iget-object v4, p0, Lcom/google/android/gtalkservice/IImSession$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getConnectionState()Lcom/google/android/gtalkservice/ConnectionState;
    ...
    .line 613
    sget-object v3, Lcom/google/android/gtalkservice/ConnectionState;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/google/android/gtalkservice/ConnectionState;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 620
    .local v2, "_result":Lcom/google/android/gtalkservice/ConnectionState;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 616
    .end local v2    # "_result":Lcom/google/android/gtalkservice/ConnectionState;
    :cond_0
    const/4 v2, 0x0

    .restart local v2    # "_result":Lcom/google/android/gtalkservice/ConnectionState;
    goto :goto_0
...
.method public getPresence()Lcom/google/android/gtalkservice/Presence;
    ...
    .line 698
    sget-object v3, Lcom/google/android/gtalkservice/Presence;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 705
    .local v2, "_result":Lcom/google/android/gtalkservice/Presence;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 701
    .end local v2    # "_result":Lcom/google/android/gtalkservice/Presence;
    :cond_0
    const/4 v2, 0x0

    .restart local v2    # "_result":Lcom/google/android/gtalkservice/Presence;
    goto :goto_0
...
.method public inviteContactsToGroupchat(Ljava/lang/String;[Ljava/lang/String;)V
    .locals 5
    .param p1, "roomJid"    # Ljava/lang/String;
    .param p2, "contacts"    # [Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public pruneOldChatSessions(JJJZ)V
    .locals 5
    .param p1, "expire"    # J
    .param p3, "expireHard"    # J
    .param p5, "expireForChatsOnOtherClient"    # J
    .param p7, "closeChatIfTimeStampIsZero"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public sendCallPerfStatsStanza(Ljava/lang/String;)V
    .locals 5
    .param p1, "callPerfStanza"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public sendSessionStanza(Ljava/lang/String;)V
    .locals 5
    .param p1, "stanza"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public setPresence(Lcom/google/android/gtalkservice/Presence;)V
    .locals 5
    .param p1, "presence"    # Lcom/google/android/gtalkservice/Presence;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
