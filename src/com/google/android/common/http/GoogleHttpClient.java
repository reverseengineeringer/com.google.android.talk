  ...
  implements HttpClient
{
  ...
  {
    // Byte code:
    //   0: invokestatic 282	android/os/SystemClock:elapsedRealtime	()J
    //   3: lstore 5
    //   5: aload_0
    //   6: getfield 37	com/google/android/common/http/GoogleHttpClient:mConnectionAllocated	Ljava/lang/ThreadLocal;
    //   9: aconst_null
    //   10: invokevirtual 286	java/lang/ThreadLocal:set	(Ljava/lang/Object;)V
    //   13: aload_0
    //   14: getfield 80	com/google/android/common/http/GoogleHttpClient:mResolver	Landroid/content/ContentResolver;
    //   17: ldc_w 288
    //   20: iconst_0
    //   21: invokestatic 294	com/google/android/gsf/Gservices:getBoolean	(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z
    //   24: ifeq +175 -> 199
    //   27: invokestatic 299	android/os/Process:myUid	()I
    //   30: istore_3
    //   31: iload_3
    //   32: invokestatic 305	android/net/TrafficStats:getUidTxBytes	(I)J
    //   35: lstore 7
    //   37: iload_3
    //   38: invokestatic 308	android/net/TrafficStats:getUidRxBytes	(I)J
    //   41: lstore 9
    //   43: aload_0
    //   44: getfield 72	com/google/android/common/http/GoogleHttpClient:mClient	Landroid/net/http/AndroidHttpClient;
    //   47: aload_1
    //   48: aload_2
    //   49: invokevirtual 309	android/net/http/AndroidHttpClient:execute	(Lorg/apache/http/client/methods/HttpUriRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    //   52: astore 13
    //   54: aload 13
    ...
    //   64: aload_2
    //   65: ifnull +42 -> 107
    //   68: invokestatic 282	android/os/SystemClock:elapsedRealtime	()J
    //   71: lstore 11
    //   73: aload 13
    //   75: new 311	com/google/android/common/http/NetworkStatsEntity
    //   78: dup
    //   79: aload_2
    //   80: aload_0
    ...
    //   93: lsub
    //   94: lload 11
    //   96: invokespecial 314	com/google/android/common/http/NetworkStatsEntity:<init>	(Lorg/apache/http/HttpEntity;Ljava/lang/String;IJJJJ)V
    //   99: invokeinterface 320 2 0
    //   104: aload 13
    //   106: astore_1
    //   107: aload_1
    //   108: invokeinterface 324 1 0
    //   113: invokeinterface 329 1 0
    //   118: istore 4
    //   120: invokestatic 282	android/os/SystemClock:elapsedRealtime	()J
    //   123: lstore 7
    //   125: aload_0
    //   126: getfield 37	com/google/android/common/http/GoogleHttpClient:mConnectionAllocated	Ljava/lang/ThreadLocal;
    //   129: invokevirtual 332	java/lang/ThreadLocal:get	()Ljava/lang/Object;
    ...
    //   153: lload 5
    //   155: lsub
    //   156: invokestatic 339	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   159: aastore
    //   160: dup
    //   161: iconst_1
    //   162: iload 4
    //   164: invokestatic 344	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   167: aastore
    //   168: dup
    //   169: iconst_2
    //   170: aload_0
    ...
    //   176: iconst_3
    //   177: iload_3
    //   178: invokestatic 344	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   181: aastore
    //   182: invokestatic 350	android/util/EventLog:writeEvent	(I[Ljava/lang/Object;)I
    //   185: pop
    //   186: aload_1
    //   187: areturn
    //   188: aload 13
    //   190: invokeinterface 354 1 0
    //   195: astore_2
    //   196: goto -135 -> 61
    //   199: aload_0
    ...
    //   203: aload_1
    //   204: aload_2
    //   205: invokevirtual 309	android/net/http/AndroidHttpClient:execute	(Lorg/apache/http/client/methods/HttpUriRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    //   208: astore_1
    //   209: goto -102 -> 107
    //   212: iconst_0
    //   213: istore_3
    ...
    //   220: ldc_w 356
    //   223: aload_2
    //   224: invokestatic 360	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   227: pop
    //   228: aload_1
    //   229: areturn
    //   230: astore_1
    //   231: invokestatic 282	android/os/SystemClock:elapsedRealtime	()J
    //   234: lstore 7
    //   236: aload_0
    //   237: getfield 37	com/google/android/common/http/GoogleHttpClient:mConnectionAllocated	Ljava/lang/ThreadLocal;
    //   240: invokevirtual 332	java/lang/ThreadLocal:get	()Ljava/lang/Object;
    ...
    //   263: lload 5
    //   265: lsub
    //   266: invokestatic 339	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   269: aastore
    //   270: dup
    //   271: iconst_1
    //   272: iconst_m1
    //   273: invokestatic 344	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   276: aastore
    //   277: dup
    //   278: iconst_2
    //   279: aload_0
    ...
    //   285: iconst_3
    //   286: iload_3
    //   287: invokestatic 344	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   290: aastore
    //   291: invokestatic 350	android/util/EventLog:writeEvent	(I[Ljava/lang/Object;)I
    //   294: pop
    //   295: aload_1
    //   296: athrow
    //   297: iconst_0
    ...
    //   305: ldc_w 356
    //   308: aload_2
    //   309: invokestatic 360	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   312: pop
    //   313: goto -18 -> 295
    // Local variable table:
    //   start	length	slot	name	signature
