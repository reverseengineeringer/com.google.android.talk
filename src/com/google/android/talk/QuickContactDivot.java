...
public class QuickContactDivot
  ...
  implements Divot
{
  ...
  public QuickContactDivot(Context paramContext)
  {
    super(paramContext);
    initialize(null);
  }
  
  public QuickContactDivot(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    initialize(paramAttributeSet);
  }
  
  public QuickContactDivot(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    assignContactFromEmail(paramString, true);
  }
...
/* Location:
 * Qualified Name:     com.google.android.talk.QuickContactDivot
