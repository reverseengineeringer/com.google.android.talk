...
{
  public static final Parcelable.Creator<FileTeleporter> CREATOR = new fyk();
  final int a;
  ...
  private java.io.FileOutputStream a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 52	com/google/android/gms/feedback/FileTeleporter:f	Ljava/io/File;
    //   4: ifnonnull +13 -> 17
    ...
    //   19: ldc 63
    //   21: aload_0
    //   22: getfield 52	com/google/android/gms/feedback/FileTeleporter:f	Ljava/io/File;
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    try
    {
      localDataOutputStream.writeInt(e.length);
      localDataOutputStream.writeUTF(c);
      localDataOutputStream.writeUTF(d);
      localDataOutputStream.write(e);
