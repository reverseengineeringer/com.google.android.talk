  ...
  implements ggi
{
  ...
  ggk(IBinder paramIBinder)
  {
    a = paramIBinder;
  }
  
  /* Error */
  public fxx a(fxx paramfxx1, fxx paramfxx2, Bundle paramBundle)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   74: aload_0
    //   75: getfield 15	ggk:a	Landroid/os/IBinder;
    //   78: iconst_4
    //   79: aload 5
    //   81: aload 6
    //   83: iconst_0
    ...
    //   100: invokestatic 65	fxy:a	(Landroid/os/IBinder;)Lfxx;
    //   103: astore_1
    //   104: aload 6
    ...
    //   0	143	0	this	ggk
    //   0	143	1	paramfxx1	fxx
    //   0	143	2	paramfxx2	fxx
  ...
  public ggf a()
  {
    ...
    try
    {
      ...
      ggf localggf = ggg.a(localParcel2.readStrongBinder());
      return localggf;
    }
    finally
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	ggk:a	Landroid/os/IBinder;
    //   33: iconst_3
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
  ...
  public void a(fxx paramfxx, StreetViewPanoramaOptions paramStreetViewPanoramaOptions, Bundle paramBundle)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    label127:
  ...
  public void a(giz paramgiz)
  {
    ...
    //   30: aload_0
    //   31: getfield 15	ggk:a	Landroid/os/IBinder;
    //   34: bipush 12
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
