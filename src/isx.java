  ...
  extends ita
{
  ...
  public isx(String paramString, boolean paramBoolean)
  {
  ...
  public String a(String paramString)
  {
      ...
      if (n < i2)
      {
        ...
        if (Character.isSupplementaryCodePoint(m))
        {
          ...
          if (localObject1.length < m) {
            localObject2 = ita.a((char[])localObject1, j, m + i2 - n + 32);
          }
          m = j;
          if (i3 > 0)
          {
    ...
    for (;;)
    {
      ...
      if (n > 0)
      {
        ...
        localObject2 = localObject1;
        if (localObject1.length < m) {
          localObject2 = ita.a((char[])localObject1, j, m);
        }
