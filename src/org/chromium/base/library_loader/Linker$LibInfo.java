...
{
  public static final Parcelable.Creator<LibInfo> CREATOR = new moa();
  @AccessedByNative
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    {
      aal.b("LibraryLoader", "Can't write LibInfo file descriptor to parcel", new Object[] { paramParcel });
    }
  }
}
