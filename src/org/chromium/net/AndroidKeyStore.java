...
public class AndroidKeyStore
{
  private static Object a(PrivateKey paramPrivateKey)
  {
    ...
    {
      aal.b("AndroidKeyStore", "privateKey == null", new Object[0]);
      return null;
    }
    if (!(paramPrivateKey instanceof RSAPrivateKey))
    {
      aal.b("AndroidKeyStore", "does not implement RSAPrivateKey", new Object[0]);
      return null;
    }
    try
    {
      ...
      {
        aal.b("AndroidKeyStore", "Private key is not an OpenSSLRSAPrivateKey instance, its class name is:" + paramPrivateKey.getClass().getCanonicalName(), new Object[0]);
        return null;
      }
    }
    catch (Exception paramPrivateKey)
    {
      aal.b("AndroidKeyStore", "Cannot find system OpenSSLRSAPrivateKey class: " + paramPrivateKey, new Object[0]);
      return null;
    }
    try
    {
    ...
    catch (Exception paramPrivateKey)
    {
      try
      {
        ...
        aal.b("AndroidKeyStore", "getOpenSSLKey() returned null", new Object[0]);
        return null;
      }
      finally
      {
      ...
      aal.b("AndroidKeyStore", "Exception while trying to retrieve system EVP_PKEY handle: " + paramPrivateKey, new Object[0]);
      return null;
    }
  }
  ...
  private static byte[] getECKeyOrder(PrivateKey paramPrivateKey)
  {
    ...
    aal.a("AndroidKeyStore", "Not an ECKey instance!", new Object[0]);
    return null;
  }
  ...
  private static Object getOpenSSLEngineForPrivateKey(PrivateKey paramPrivateKey)
  {
    ...
    //   40: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   43: aconst_null
    //   44: areturn
    //   45: aload_2
    ...
    //   91: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   94: aload_1
    //   95: aload_2
    ...
    //   130: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   133: aconst_null
    //   134: areturn
    //   135: astore_0
    //   136: ldc 16
    ...
    //   158: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   161: aconst_null
    //   162: areturn
    //   163: astore_0
    //   164: ldc 16
    ...
    //   186: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aload_0
  ...
  private static long getOpenSSLHandleForPrivateKey(PrivateKey paramPrivateKey)
  {
    ...
    //   73: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   76: lload_3
    //   77: lreturn
    //   78: astore_0
    //   79: ldc 16
    ...
    //   101: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   104: lconst_0
    //   105: lreturn
    //   106: astore_0
    //   107: ldc 16
    ...
    //   129: invokestatic 24	aal:b	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   132: lconst_0
    //   133: lreturn
    //   134: astore 5
    //   136: aload_0
  ...
  private static byte[] getRSAKeyModulus(PrivateKey paramPrivateKey)
  {
    ...
    aal.a("AndroidKeyStore", "Not a RSAKey instance!", new Object[0]);
    return null;
  }
  ...
  private static byte[] rawSignDigestWithPrivateKey(PrivateKey paramPrivateKey, byte[] paramArrayOfByte)
  {
    try
    {
      ...
      for (localObject1 = Signature.getInstance("NONEwithRSA");; localObject1 = Signature.getInstance("NONEwithECDSA"))
      {
        ...
        aal.b("AndroidKeyStore", "Unsupported private key algorithm: " + paramPrivateKey.getAlgorithm(), new Object[0]);
        return null;
    ...
    catch (NoSuchAlgorithmException localNoSuchAlgorithmException)
    {
      ...
      {
        aal.b("AndroidKeyStore", "Exception while signing message with " + paramPrivateKey.getAlgorithm() + " private key: " + paramArrayOfByte, new Object[0]);
      }
    }
    return null;
  }
