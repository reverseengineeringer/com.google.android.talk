  ...
  implements gqn
{
  ...
  public void a(int paramInt, Account paramAccount, gqk paramgqk)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAccount != null)
        {
          ...
          if (paramgqk != null)
          {
            paramAccount = paramgqk.asBinder();
  ...
  public void a(AuthAccountRequest paramAuthAccountRequest, gqk paramgqk)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAuthAccountRequest != null)
        {
          ...
          if (paramgqk != null)
          {
            paramAuthAccountRequest = paramgqk.asBinder();
  ...
  public void a(ResolveAccountRequest paramResolveAccountRequest, fmd paramfmd)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramResolveAccountRequest != null)
        {
          ...
          if (paramfmd != null)
          {
            paramResolveAccountRequest = paramfmd.asBinder();
  ...
  /* Error */
  public void a(com.google.android.gms.signin.internal.CheckServerAuthResult paramCheckServerAuthResult)
  {
    // Byte code:
    ...
    //   29: aload_0
    //   30: getfield 15	gqp:a	Landroid/os/IBinder;
    //   33: iconst_3
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
  ...
  public void a(RecordConsentRequest paramRecordConsentRequest, gqk paramgqk)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramRecordConsentRequest != null)
        {
          ...
          if (paramgqk != null)
          {
            paramRecordConsentRequest = paramgqk.asBinder();
  ...
  /* Error */
  public void a(fks paramfks, int paramInt, boolean paramBoolean)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   58: aload_0
    //   59: getfield 15	gqp:a	Landroid/os/IBinder;
    //   62: bipush 9
    //   64: aload 5
    //   66: aload 6
    //   68: iconst_0
  ...
  public void a(gqk paramgqk)
  {
    ...
    //   30: aload_0
    //   31: getfield 15	gqp:a	Landroid/os/IBinder;
    //   34: bipush 11
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
