...
public final class fi
{
  ...
  private final HashMap<String, ArrayList<fl>> c = new HashMap();
  private final ArrayList<fk> d = new ArrayList();
  private final Handler e;
  
  private fi(Context paramContext)
  {
    a = paramContext;
    e = new fj(this, paramContext.getMainLooper());
  }
  
  public static fi a(Context paramContext)
  {
    synchronized (f)
    {
      if (g == null) {
        g = new fi(paramContext.getApplicationContext());
      }
      paramContext = g;
      return paramContext;
    }
  ...
  void a()
  {
    for (;;)
    {
      ...
      synchronized (b)
      {
        ...
        fk[] arrayOffk = new fk[i];
        d.toArray(arrayOffk);
        d.clear();
        i = 0;
        if (i >= arrayOffk.length) {
          continue;
        }
        ??? = arrayOffk[i];
        int j = 0;
  ...
  public void a(BroadcastReceiver paramBroadcastReceiver, IntentFilter paramIntentFilter)
  {
    synchronized (b)
    {
      fl localfl = new fl(paramIntentFilter, paramBroadcastReceiver);
      ...
      while (i < paramIntentFilter.countActions())
      {
        ...
        paramBroadcastReceiver.add(localfl);
        i += 1;
      }
      return;
    }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    synchronized (b)
    {
      ...
      fl localfl = (fl)localArrayList2.get(j);
      if (i != 0) {
    ...
    for (;;)
    {
      ...
      {
        d.add(new fk(paramIntent, localArrayList1));
        if (!e.hasMessages(1)) {
