  ...
  implements ggc
{
  ...
  gge(IBinder paramIBinder)
  {
    a = paramIBinder;
  }
  
  /* Error */
  public com.google.android.gms.maps.model.LatLng a(fxx paramfxx)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   33: aload_0
    //   34: getfield 15	gge:a	Landroid/os/IBinder;
    //   37: iconst_1
    //   38: aload_3
    //   39: aload 4
    //   41: iconst_0
    ...
    //   60: ifeq +13 -> 73
    //   63: getstatic 57	com/google/android/gms/maps/model/LatLng:CREATOR	Lgkq;
    //   66: astore_1
    //   67: aload 4
    //   69: invokestatic 62	gkq:a	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/LatLng;
    //   72: astore_1
    //   73: aload 4
  ...
  public com.google.android.gms.maps.model.VisibleRegion a()
  {
    ...
    //   14: aload_0
    //   15: getfield 15	gge:a	Landroid/os/IBinder;
    //   18: iconst_3
    //   19: aload_2
    //   20: aload_3
    //   21: iconst_0
    ...
    //   36: ifeq +22 -> 58
    //   39: getstatic 71	com/google/android/gms/maps/model/VisibleRegion:CREATOR	Lglb;
    //   42: astore_1
    //   43: aload_3
    //   44: invokestatic 76	glb:a	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/VisibleRegion;
    //   47: astore_1
    //   48: aload_3
  ...
  public fxx a(com.google.android.gms.maps.model.LatLng paramLatLng)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	gge:a	Landroid/os/IBinder;
    //   33: iconst_2
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
    ...
    //   47: aload_3
    //   48: invokevirtual 88	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
    //   51: invokestatic 93	fxy:a	(Landroid/os/IBinder;)Lfxx;
    //   54: astore_1
    //   55: aload_3
    ...
    //   65: aload_2
    //   66: iconst_0
    //   67: invokevirtual 81	android/os/Parcel:writeInt	(I)V
    //   70: goto -41 -> 29
    //   73: astore_1
    //   74: aload_3
    //   75: invokevirtual 65	android/os/Parcel:recycle	()V
