  ...
  implements gjo
{
  ...
  public gjq(IBinder paramIBinder)
  {
    a = paramIBinder;
  }
  ...
  /* Error */
  public fxx a(android.graphics.Bitmap paramBitmap)
  {
    // Byte code:
    ...
    //   29: aload_0
    //   30: getfield 15	gjq:a	Landroid/os/IBinder;
    //   33: bipush 6
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
  ...
  public fxx a(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
    {
      ...
      localParcel2.readException();
      paramString = fxy.a(localParcel2.readStrongBinder());
      return paramString;
    }
    finally
    {
  ...
  public fxx b(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
  ...
  public fxx c(String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    try
