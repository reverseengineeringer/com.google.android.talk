  ...
  implements cr, cs
{
  ...
  {
    c.add(dr.a(a, paramdo));
  }
  
  public Notification b()
  {
    Notification localNotification = a.build();
    Object localObject = dr.a(localNotification);
    ...
    localObject = dr.a(c);
    if (localObject != null) {
      dr.a(localNotification).putSparseParcelableArray("android.support.actionExtras", (SparseArray)localObject);
    }
