...
public final class irq
{
  ...
  public static final irv l = new irv();
    ...
    if (localObject1 == null) {
      for (;;)
      {
        synchronized (m)
        {
          ...
          localObject1 = irm.a(paramClass).a(null);
          if (localObject1 == null) {
            throw new NullPointerException(fii.a("enum missing constant with @NullValue annotation: %s", new Object[] { paramClass }));
          }
        }
        localObject1 = ((iry)localObject1).f();
        continue;
        label149:
        localObject1 = aal.a(paramClass);
      }
    }
    return (T)localObject1;
  }
  ...
  public static Object a(Type paramType, String paramString)
  {
    ...
    label481:
    int i8;
    if (localObject1 == irv.class)
    {
      paramType = irv.b.matcher(paramString);
      ...
      if (paramType.group(4) != null)
      {
        ...
        paramType = String.valueOf("Invalid date/time format, cannot specify time zone shift without specifying time: ");
        paramString = String.valueOf(paramString);
        if (paramString.length() == 0) {
          break label469;
        }
      }
      for (paramType = paramType.concat(paramString);; paramType = new String(paramType))
      {
        throw new NumberFormatException(paramType);
        i3 = 0;
        break;
    ...
    for (;;)
    {
      paramString = new GregorianCalendar(irv.a);
      ...
      for (paramType = Integer.valueOf(n);; paramType = null)
      {
        ...
        {
          return new irv(bool, l1, paramType);
        ...
        if (((Class)localObject1).isEnum()) {
          return irm.a((Class)localObject1).a(paramString).f();
        }
        label801:
  ...
  public static Type a(List<Type> paramList, Type paramType)
  {
    if ((paramType instanceof WildcardType)) {
      paramType = aal.a((WildcardType)paramType);
    }
    for (;;)
    {
      if ((paramType instanceof TypeVariable))
      {
        Type localType = aal.a(paramList, (TypeVariable)paramType);
        if (localType == null) {
          break label64;
        }
        paramType = localType;
  ...
  public static void a(Object paramObject1, Object paramObject2)
  {
    ...
    {
      fii.a(bool1);
      paramObject1 = aal.e(paramObject1).iterator();
      n = i1;
    ...
    {
      if (bool1) {}
      for (localObject1 = classInfo;; localObject1 = irm.a((Class)localObject1))
      {
        Iterator localIterator = b.iterator();
        while (localIterator.hasNext())
        {
          iry localiry = ((irm)localObject1).a((String)localIterator.next());
          if ((!localiry.d()) && ((!bool1) || (!localiry.e())))
          {
            Object localObject2 = localiry.a(paramObject1);
            if (localObject2 != null) {
              localiry.a(paramObject2, c(localObject2));
            }
          }
        }
      }
    }
    if (ira.class.isAssignableFrom((Class)localObject1))
    {
      paramObject2 = (ira)paramObject2;
      paramObject1 = (ira)paramObject1;
      i1 = ((ira)paramObject1).size();
      while (n < i1)
      {
        ((ira)paramObject2).a(n, c(((ira)paramObject1).a(n)));
        n += 1;
      }
    }
  ...
  public static boolean a(Type paramType)
  {
    ...
    for (;;)
    {
      ...
      return (paramType.isPrimitive()) || (paramType == Character.class) || (paramType == String.class) || (paramType == Integer.class) || (paramType == Long.class) || (paramType == Short.class) || (paramType == Byte.class) || (paramType == Float.class) || (paramType == Double.class) || (paramType == BigInteger.class) || (paramType == BigDecimal.class) || (paramType == irv.class) || (paramType == Boolean.class);
    }
  }
  ...
  public static Collection<Object> b(Type paramType)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return (Collection)aal.a(localClass);
      }
    }
  }
  ...
  {
    if ((paramClass == null) || (paramClass.isAssignableFrom(ira.class))) {
      return new ira();
    }
    if (paramClass.isAssignableFrom(TreeMap.class)) {
      return new TreeMap();
    }
    return (Map)aal.a(paramClass);
  }
  ...
  public static Map<String, Object> b(Object paramObject)
  {
    ...
    return new irr(paramObject, false);
  }
  ...
  public static <T> T c(T paramT)
  {
    ...
    for (;;)
    {
      ...
      if ((paramT instanceof ira))
      {
        localObject = ((ira)paramT).a();
      }
      else
      {
        ...
        localObject = aal.a((Class)localObject);
      }
    }
  }
