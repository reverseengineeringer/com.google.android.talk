...
public abstract class gqo
  ...
  implements gqn
{
  public static gqn a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.google.android.gms.signin.internal.ISignInService");
    if ((localIInterface != null) && ((localIInterface instanceof gqn))) {
      return (gqn)localIInterface;
    }
    return new gqp(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 2: 
      ...
      {
        a((AuthAccountRequest)localObject, gql.a(paramParcel1.readStrongBinder()));
    ...
    case 5: 
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof fmd))) {
          paramParcel1 = (fmd)localIInterface;
        } else {
          paramParcel1 = new fmf(paramParcel1);
        }
      }
    case 7: 
      paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
    ...
    case 8: 
      ...
      {
        a(paramInt1, (Account)localObject, gql.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
    case 9: 
      paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
      localObject = fkt.a(paramParcel1.readStrongBinder());
      paramInt1 = paramParcel1.readInt();
      bool1 = bool2;
      if (paramParcel1.readInt() != 0) {
        bool1 = true;
      }
      a((fks)localObject, paramInt1, bool1);
      paramParcel2.writeNoException();
      return true;
    case 10: 
      label298:
      ...
      {
        a((RecordConsentRequest)localObject, gql.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
    }
    paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
    a(gql.a(paramParcel1.readStrongBinder()));
    paramParcel2.writeNoException();
    return true;
  }
}
