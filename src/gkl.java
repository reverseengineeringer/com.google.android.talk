  ...
  implements gkj
{
  ...
  public gkl(IBinder paramIBinder)
  {
    a = paramIBinder;
  }
  ...
  public com.google.android.gms.maps.model.Tile a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   35: aload_0
    //   36: getfield 15	gkl:a	Landroid/os/IBinder;
    //   39: iconst_1
    //   40: aload 5
    //   42: aload 6
    //   44: iconst_0
    ...
    //   61: ifeq +28 -> 89
    //   64: getstatic 52	com/google/android/gms/maps/model/Tile:CREATOR	Lgkz;
    //   67: astore 4
    //   69: aload 6
    //   71: invokestatic 57	gkz:a	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/Tile;
    //   74: astore 4
    //   76: aload 6
