  ...
  implements iu
{
  ...
  public iv(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    float f3;
    label130:
    for (int i3 = jx.b(paramMotionEvent);; i3 = -1)
    {
      i5 = jx.a.a(paramMotionEvent);
      i4 = 0;
      f1 = 0.0F;
      for (f2 = 0.0F; i4 < i5; f2 = f3)
      {
        ...
        if (i3 != i4)
        {
          f3 = f2 + jx.c(paramMotionEvent, i4);
          f4 = f1 + jx.d(paramMotionEvent, i4);
        }
        i4 += 1;
        f1 = f4;
      }
    ...
    case 2: 
      do
      {
        ...
        i3 = jx.b(paramMotionEvent);
        i1 = jx.b(paramMotionEvent, i3);
        f1 = ko.a(x, i1);
        f2 = ko.b(x, i1);
        i1 = 0;
        while (i1 < i5)
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject = x;
          i2 = jx.b(paramMotionEvent, 0);
          ((VelocityTracker)localObject).computeCurrentVelocity(1000, k);
          f1 = ko.b((VelocityTracker)localObject, i2);
          f2 = ko.a((VelocityTracker)localObject, i2);
