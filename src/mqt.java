...
{
  public mqt(ProxyChangeListener paramProxyChangeListener) {}
  
  private static mqs a(Intent paramIntent)
  {
    for (;;)
    {
      try
        ...
        if (Build.VERSION.SDK_INT < 21)
        {
          ...
          if (Build.VERSION.SDK_INT < 21)
          {
            ...
            if ((Build.VERSION.SDK_INT >= 19) && (Build.VERSION.SDK_INT < 21))
            {
              ...
              return new mqs((String)localObject1, i, (String)localObject2, paramIntent);
            }
          }
          else
          {
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            ...
            if (!Uri.EMPTY.equals(localObject2)) {
              return new mqs((String)localObject1, i, ((Uri)localObject2).toString(), paramIntent);
            }
          }
          paramIntent = new mqs((String)localObject1, i, null, paramIntent);
          return paramIntent;
        }
      }
