  ...
  extends ListView
{
  ...
  public vj(Context paramContext, int paramInt)
  {
  ...
  public void a(int paramInt, View paramView, float paramFloat1, float paramFloat2)
  {
    a(paramInt, paramView);
    paramView = getSelector();
    if ((paramView != null) && (paramInt != -1)) {
      fv.a(paramView, paramFloat1, paramFloat2);
    }
  }
  ...
  public void setSelector(Drawable paramDrawable)
  {
    ...
    for (Object localObject = new vk(paramDrawable);; localObject = null)
    {
      i = ((vk)localObject);
      super.setSelector(i);
