  ...
  implements geb
{
  ...
  public android.location.Location a()
  {
    ...
    //   14: aload_0
    //   15: getfield 15	ged:a	Landroid/os/IBinder;
    //   18: bipush 7
    //   20: aload_2
    //   21: aload_3
    //   22: iconst_0
  ...
  public Status a(GestureRequest paramGestureRequest, PendingIntent paramPendingIntent)
  {
  ...
  /* Error */
  public com.google.android.gms.location.ActivityRecognitionResult a(String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   19: aload_0
    //   20: getfield 15	ged:a	Landroid/os/IBinder;
    //   23: bipush 64
    //   25: aload_2
    //   26: aload_3
    //   27: iconst_0
    ...
    //   42: ifeq +22 -> 64
    //   45: getstatic 83	com/google/android/gms/location/ActivityRecognitionResult:CREATOR	Lgdm;
    //   48: astore_1
    //   49: aload_3
    //   50: invokestatic 88	gdm:a	(Landroid/os/Parcel;)Lcom/google/android/gms/location/ActivityRecognitionResult;
    //   53: astore_1
    //   54: aload_3
  ...
  public void a(long paramLong, boolean paramBoolean, PendingIntent paramPendingIntent)
  {
    ...
    //   20: aload 6
    //   22: lload_1
    //   23: invokevirtual 93	android/os/Parcel:writeLong	(J)V
    //   26: iload_3
    //   27: ifeq +61 -> 88
    //   30: aload 6
    //   32: iload 5
    ...
    //   56: aload_0
    //   57: getfield 15	ged:a	Landroid/os/IBinder;
    //   60: iconst_5
    //   61: aload 6
    //   63: aload 7
    //   65: iconst_0
  ...
  public void a(PendingIntent paramPendingIntent)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	ged:a	Landroid/os/IBinder;
    //   33: bipush 6
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
  ...
  public void a(PendingIntent paramPendingIntent, gdy paramgdy, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramPendingIntent != null)
        {
          ...
          if (paramgdy != null)
          {
            paramPendingIntent = paramgdy.asBinder();
  ...
  public void a(android.location.Location paramLocation)
  {
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 106	android/location/Location:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	ged:a	Landroid/os/IBinder;
    //   33: bipush 13
    //   35: aload_2
  ...
  public void a(android.location.Location paramLocation, int paramInt)
  {
    ...
    //   19: aload_3
    //   20: iconst_1
    //   21: invokevirtual 62	android/os/Parcel:writeInt	(I)V
    //   24: aload_1
    //   25: aload_3
    //   26: iconst_0
    //   27: invokevirtual 106	android/location/Location:writeToParcel	(Landroid/os/Parcel;I)V
    //   30: aload_3
    //   31: iload_2
    //   32: invokevirtual 62	android/os/Parcel:writeInt	(I)V
    //   35: aload_0
    //   36: getfield 15	ged:a	Landroid/os/IBinder;
    //   39: bipush 26
    //   41: aload_3
    //   42: aload 4
    //   44: iconst_0
  ...
  public void a(GeofencingRequest paramGeofencingRequest, PendingIntent paramPendingIntent, gdy paramgdy)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGeofencingRequest != null)
        {
          ...
          if (paramPendingIntent != null)
          {
            ...
            paramGeofencingRequest = paramgdy.asBinder();
  ...
  public void a(LocationRequest paramLocationRequest, gez paramgez)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationRequest != null)
        {
          ...
          if (paramgez != null)
          {
            paramLocationRequest = paramgez.asBinder();
  ...
  public void a(LocationRequest paramLocationRequest, gez paramgez, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public void a(LocationSettingsRequest paramLocationSettingsRequest, gee paramgee, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationSettingsRequest != null)
        {
          ...
          if (paramgee != null)
          {
            paramLocationSettingsRequest = paramgee.asBinder();
  ...
  public void a(LocationRequestInternal paramLocationRequestInternal, gez paramgez)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationRequestInternal != null)
        {
          ...
          if (paramgez != null)
          {
            paramLocationRequestInternal = paramgez.asBinder();
  ...
  /* Error */
  public void a(com.google.android.gms.location.internal.LocationRequestUpdateData paramLocationRequestUpdateData)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 136	com/google/android/gms/location/internal/LocationRequestUpdateData:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	ged:a	Landroid/os/IBinder;
    //   33: bipush 59
    //   35: aload_2
  ...
  /* Error */
  public void a(gdy paramgdy, String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_3
    ...
    //   26: aload_3
    //   27: aload_1
    //   28: invokevirtual 104	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
    //   31: aload_3
    //   32: aload_2
    //   33: invokevirtual 78	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   36: aload_0
    //   37: getfield 15	ged:a	Landroid/os/IBinder;
    //   40: iconst_4
    //   41: aload_3
    //   42: aload 4
    //   44: iconst_0
  ...
  public void a(gez paramgez)
  {
    ...
    //   25: aload_2
    //   26: aload_1
    //   27: invokevirtual 104	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
    //   30: aload_0
    //   31: getfield 15	ged:a	Landroid/os/IBinder;
    //   34: bipush 10
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
  ...
  public void a(List<ParcelableGeofence> paramList, PendingIntent paramPendingIntent, gdy paramgdy, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  /* Error */
  public void a(String[] paramArrayOfString, gdy paramgdy, String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore 4
    ...
    //   17: aload 4
    //   19: aload_1
    //   20: invokevirtual 151	android/os/Parcel:writeStringArray	([Ljava/lang/String;)V
    //   23: aload_2
    //   24: ifnull +54 -> 78
    //   27: aload_2
    ...
    //   34: aload 4
    //   36: aload_1
    //   37: invokevirtual 104	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
    //   40: aload 4
    //   42: aload_3
    //   43: invokevirtual 78	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   46: aload_0
    //   47: getfield 15	ged:a	Landroid/os/IBinder;
    //   50: iconst_3
    //   51: aload 4
    //   53: aload 5
    //   55: iconst_0
  ...
  /* Error */
  public android.location.Location b(String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
  ...
  public Status b(PendingIntent paramPendingIntent)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public Status c(PendingIntent paramPendingIntent)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  /* Error */
  public com.google.android.gms.location.LocationAvailability c(String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   39: invokevirtual 42	android/os/Parcel:readInt	()I
    //   42: ifeq +22 -> 64
    //   45: getstatic 164	com/google/android/gms/location/LocationAvailability:CREATOR	Lgdp;
    //   48: astore_1
    //   49: aload_3
    //   50: invokestatic 169	gdp:a	(Landroid/os/Parcel;)Lcom/google/android/gms/location/LocationAvailability;
    //   53: astore_1
    //   54: aload_3
    //   55: invokevirtual 57	android/os/Parcel:recycle	()V
    //   58: aload_2
  ...
  public Status d(PendingIntent paramPendingIntent)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  /* Error */
  public void e(PendingIntent paramPendingIntent)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
