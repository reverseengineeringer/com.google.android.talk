...
public final class af
{
  ...
  public static List<File> a(Context paramContext, ApplicationInfo paramApplicationInfo, File paramFile, boolean paramBoolean)
  {
    ...
    long l2 = aal.a(paramApplicationInfo);
    long l1 = l2;
    if (l2 == -1L) {
      l1 = l2 - 1L;
    }
    if (!paramBoolean)
    {
      ...
      if ((localSharedPreferences.getLong("timestamp", -1L) != b(paramApplicationInfo)) || (localSharedPreferences.getLong("crc", -1L) != l1)) {
        i = 1;
      }
      if (i != 0) {}
    }
  ...
  private static void a(File paramFile, String paramString)
  {
    ...
    paramString = paramFile.listFiles(new ag(paramString));
    if (paramString == null)
    {
